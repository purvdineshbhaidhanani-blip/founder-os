...
description: Manages all platform configuration, feature flags, model routing and connector credentials.
...
- **Tags:** engineering-department, platform, foundation, configuration, settings
...
- **Output format:** Delivers results to orchestrator-agent, logger-agent; artifacts are published through the Artifact Manager and recorded in shared memory, then announced on the Event Bus.
...
- **Collaborates with:** logger-agent, orchestrator-agent
...
- **Blueprint name:** configuration-manager
- **Blueprint content hash:** cf8b583a61d964f1
- **Generated at:** 2026-07-01T06:26:20.471Z
