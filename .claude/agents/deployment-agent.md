...
description: Packages the validated application into a deployable, production-ready build.
...
- **Tags:** engineering-department, app-generation, devops, deployment
...
- **Input format:** Receives work from qa-engineer-app via the Master Orchestrator's task queue, with task context loaded by the Context Manager.
...
- **Collaborates with:** qa-engineer-app, solution-architect-app
...
- **Blueprint name:** deployment-agent
- **Blueprint content hash:** 0f2b177620f7ae2f
- **Generated at:** 2026-07-01T09:36:05.337Z
