...
description: Unearths the core problem the idea solves through research and founder interviews.
...
> Unearths the core problem the idea solves through research and founder interviews.

- **Category:** research
- **Owner:** engineering-department
- **Tags:** engineering-department, product, discovery, research
...
- **Input format:** Receives work from idea-validator via the Master Orchestrator's task queue, with task context loaded by the Context Manager.
- **Output format:** Delivers results to target-audience-agent, user-research-agent; artifacts are published through the Artifact Manager and recorded in shared memory, then announced on the Event Bus.
- **Escalation path:** Reports to idea-validator. On failure, emits a failure event on the Event Bus; the Master Orchestrator applies the task-queue retry policy and routes any human-gated step through the Approval System before resuming the workflow.
- **Collaborates with:** idea-validator, target-audience-agent, user-research-agent
...
- **Blueprint name:** problem-discovery-agent
- **Blueprint content hash:** 2881a5a43152c254
- **Generated at:** 2026-07-01T07:06:06.252Z
