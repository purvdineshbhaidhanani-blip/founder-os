...
description: Generates the universal, locked 10-section SaaS business rules engine for any SaaS idea — never domain-specific business logic.
tools: Read, Grep, Glob
model: opus
---

# SaaS Business Engine Agent

> Generates the universal, locked 10-section SaaS business rules engine for any SaaS idea — never domain-specific business logic.

- **Category:** architecture
- **Owner:** engineering-department
- **Tags:** engineering-department, app-generation, architecture, saas-business-engine, business-rules
...
- **Blueprint name:** saas-business-engine-agent
- **Blueprint content hash:** e020c495870deafc
- **Generated at:** 2026-07-18T09:00:09.286Z
