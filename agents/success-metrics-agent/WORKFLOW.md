# Workflow — Success Metrics Agent

## Research Pipeline

1. **Receive** — Accept research query from user-story-generator.
...
7. **Hand Off** — Send output to product-discovery-report-generator; no silent failures.

## Failure Modes

- Insufficient evidence: Report confidence < 0.6; flag as gap
- Contradictory findings: Escalate to user-story-generator; don't guess
