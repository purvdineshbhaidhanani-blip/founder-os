# Workflow — Quality Controller

## Execution Steps

1. **Receive** — Accept task from agent-generator, prompt-optimizer via the Master Orchestrator's Task Queue.
...
7. **Hand Off** — Notify orchestrator-agent, agent-registry via the Communication Bus that results are ready.
