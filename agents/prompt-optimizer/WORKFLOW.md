...
1. **Receive** — Accept task from orchestrator-agent, quality-controller via the Master Orchestrator's Task Queue.
...
7. **Hand Off** — Notify agent-generator, quality-controller via the Communication Bus that results are ready.
