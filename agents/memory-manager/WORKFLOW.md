...
1. **Receive** — Accept task from orchestrator-agent, context-manager via the Master Orchestrator's Task Queue.
...
7. **Hand Off** — Notify orchestrator-agent, context-manager, knowledge-manager via the Communication Bus that results are ready.
