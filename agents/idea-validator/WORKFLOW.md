# Workflow — Idea Validator

## Research Pipeline

1. **Receive** — Accept research query from founder.
...
7. **Hand Off** — Send output to problem-discovery-agent; no silent failures.

## Failure Modes

- Insufficient evidence: Report confidence < 0.6; flag as gap
- Contradictory findings: Escalate to founder; don't guess
