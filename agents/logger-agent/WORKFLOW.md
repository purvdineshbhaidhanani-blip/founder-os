# Workflow — Logger Agent

## Execution Steps

1. **Receive** — Accept task from orchestrator-agent, quality-controller, workflow-engine via the Master Orchestrator's Task Queue.
...
7. **Hand Off** — Notify report-generator, orchestrator-agent via the Communication Bus that results are ready.
