# Workflow — Problem Discovery Agent

## Research Pipeline

1. **Receive** — Accept research query from idea-validator.
...
7. **Hand Off** — Send output to target-audience-agent, user-research-agent; no silent failures.

## Failure Modes

- Insufficient evidence: Report confidence < 0.6; flag as gap
- Contradictory findings: Escalate to idea-validator; don't guess
