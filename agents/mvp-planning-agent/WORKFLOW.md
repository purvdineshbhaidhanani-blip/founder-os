# Workflow — MVP Planning Agent

## Research Pipeline

1. **Receive** — Accept research query from feature-planning-agent.
...
7. **Hand Off** — Send output to user-story-generator; no silent failures.

## Failure Modes

- Insufficient evidence: Report confidence < 0.6; flag as gap
- Contradictory findings: Escalate to feature-planning-agent; don't guess
