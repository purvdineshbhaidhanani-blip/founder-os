# Workflow — Product Strategy Agent

## Research Pipeline

1. **Receive** — Accept research query from business-model-agent.
...
7. **Hand Off** — Send output to feature-planning-agent; no silent failures.

## Failure Modes

- Insufficient evidence: Report confidence < 0.6; flag as gap
- Contradictory findings: Escalate to business-model-agent; don't guess
