...
1. **Receive** — Accept task from founder, orchestrator-agent via the Master Orchestrator's Task Queue.
...
7. **Hand Off** — Notify agent-generator, orchestrator-agent via the Communication Bus that results are ready.
