# Checklist — QA Engineer (App Generation)

## Pre-Work

- [ ] Upstream artifacts from developer-agent received and complete
...
- [ ] Structured JSON ready for deployment-agent, developer-agent to consume
