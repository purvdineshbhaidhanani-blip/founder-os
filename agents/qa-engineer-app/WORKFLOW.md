# Workflow — QA Engineer (App Generation)

## Execution Steps

1. **Receive** — Accept upstream artifacts from developer-agent via the Task Queue.
...
6. **Hand Off** — Deliver structured output to deployment-agent, developer-agent; announce via the Event Bus.
