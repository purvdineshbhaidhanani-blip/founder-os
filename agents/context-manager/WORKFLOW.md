...
1. **Receive** — Accept task from orchestrator-agent, memory-manager via the Master Orchestrator's Task Queue.
...
7. **Hand Off** — Notify orchestrator-agent, agent-generator, workflow-engine via the Communication Bus that results are ready.
