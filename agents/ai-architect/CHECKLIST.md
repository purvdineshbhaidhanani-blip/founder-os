# Checklist — AI Architect

## Pre-Work

- [ ] Upstream artifacts from solution-architect-app, backend-architect received and complete
...
- [ ] Structured JSON ready for developer-agent to consume
