# Workflow — Market Research Agent

## Research Pipeline

1. **Receive** — Accept research query from target-audience-agent.
...
7. **Hand Off** — Send output to competitor-intelligence-agent; no silent failures.

## Failure Modes

- Insufficient evidence: Report confidence < 0.6; flag as gap
- Contradictory findings: Escalate to target-audience-agent; don't guess
