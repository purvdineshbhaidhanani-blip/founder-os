# Workflow — User Research Agent

## Research Pipeline

1. **Receive** — Accept research query from problem-discovery-agent, trend-intelligence-agent.
...
7. **Hand Off** — Send output to opportunity-discovery-agent; no silent failures.
