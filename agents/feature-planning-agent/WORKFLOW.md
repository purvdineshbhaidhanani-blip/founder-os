# Workflow — Feature Planning Agent

## Research Pipeline

1. **Receive** — Accept research query from product-strategy-agent.
...
7. **Hand Off** — Send output to mvp-planning-agent; no silent failures.

## Failure Modes

- Insufficient evidence: Report confidence < 0.6; flag as gap
- Contradictory findings: Escalate to product-strategy-agent; don't guess
