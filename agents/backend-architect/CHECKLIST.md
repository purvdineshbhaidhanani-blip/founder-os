# Checklist — Backend Architect

## Pre-Work

- [ ] Upstream artifacts from solution-architect-app, application-architect received and complete
...
- [ ] Ambiguities escalated to solution-architect-app, not guessed
...
- [ ] Structured JSON ready for developer-agent, database-architect to consume
