...
1. **Receive** — Accept upstream artifacts from solution-architect-app, application-architect via the Task Queue.
...
6. **Hand Off** — Deliver structured output to developer-agent, database-architect; announce via the Event Bus.
