# Workflow — Agent Generator

## Execution Steps

1. **Receive** — Accept task from orchestrator-agent, requirement-analyzer via the Master Orchestrator's Task Queue.
...
7. **Hand Off** — Notify agent-registry, quality-controller via the Communication Bus that results are ready.
