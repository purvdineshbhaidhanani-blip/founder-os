# Workflow — Competitor Intelligence Agent

## Research Pipeline

1. **Receive** — Accept research query from market-research-agent.
...
7. **Hand Off** — Send output to trend-intelligence-agent; no silent failures.

## Failure Modes

- Insufficient evidence: Report confidence < 0.6; flag as gap
- Contradictory findings: Escalate to market-research-agent; don't guess
