...
1. **Receive** — Accept upstream artifacts from application-architect, backend-architect, database-architect, ai-architect via the Task Queue.
...
6. **Hand Off** — Deliver structured output to qa-engineer-app; announce via the Event Bus.
