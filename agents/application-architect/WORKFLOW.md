# Workflow — Application Architect

## Execution Steps

1. **Receive** — Accept upstream artifacts from solution-architect-app via the Task Queue.
...
6. **Hand Off** — Deliver structured output to developer-agent; announce via the Event Bus.
