# Validation & Acceptance Criteria — Business Model Agent
...
- Integration test: pricing-strategy-agent, opportunity-discovery-agent → business-model-agent → product-strategy-agent ✓
