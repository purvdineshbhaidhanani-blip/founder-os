# Workflow — Business Model Agent

## Research Pipeline

1. **Receive** — Accept research query from pricing-strategy-agent, opportunity-discovery-agent.
...
7. **Hand Off** — Send output to product-strategy-agent; no silent failures.

## Failure Modes

- Insufficient evidence: Report confidence < 0.6; flag as gap
- Contradictory findings: Escalate to pricing-strategy-agent; don't guess
