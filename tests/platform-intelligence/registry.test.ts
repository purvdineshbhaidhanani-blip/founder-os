...
import { BUILTIN_INTELLIGENCE_MODULES } from "../../src/platform-intelligence/registry/catalog.js";
import { IntelligenceRegistry } from "../../src/platform-intelligence/registry/registry.js";
import { compareSemVer, satisfiesMinVersion } from "../../src/platform-intelligence/registry/semver.js";
...
describe("Intelligence Registry", () => {
  ...
  describe("discover()", () => {
    ...
    beforeEach(async () => {
      ...
      const dir = path.join(root, "src", "platform-intelligence", "custom-module");
