  ...
  return (
    <main className="ca-auth-page">
      <Card className="ca-auth-card">
        <CardHeader>
          <CardTitle>Start scanning for free</CardTitle>
          <CardDescription>No credit card required — 1 developer, 1 private repo, free forever.</CardDescription>
        </CardHeader>
        <CardContent>
          <form className="ca-auth-form" onSubmit={handleSubmit}>
