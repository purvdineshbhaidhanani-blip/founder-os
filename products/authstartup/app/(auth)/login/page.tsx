...
export default function LoginPage() {
  ...
  return (
    <main className="au-auth-page">
      <Card className="au-auth-card">
        <CardHeader>
          <CardTitle>Log in to AuthStartup</CardTitle>
          <CardDescription>Welcome back.</CardDescription>
        </CardHeader>
        <CardContent>
          <form className="au-auth-form" onSubmit={handleSubmit}>
