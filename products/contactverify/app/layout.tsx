...
export const metadata: Metadata = {
  title: "ContactVerify — AI-powered contact verification and data quality",
  description: "Every contact gets a complete health profile — not just valid or invalid.",
};
