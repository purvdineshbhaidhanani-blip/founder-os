...
export default function LoginPage() {
  ...
  return (
    <main className="ea-auth-page">
      <Card className="ea-auth-card">
        <CardHeader>
          <CardTitle>Log in to ERPAudit</CardTitle>
          <CardDescription>Welcome back.</CardDescription>
        </CardHeader>
        <CardContent>
          <form className="ea-auth-form" onSubmit={handleSubmit}>
