...
export const metadata: Metadata = {
  title: "ERPAudit — Continuous ERP compliance intelligence",
  description: "Continuously explains which ERP settings are wrong, why they're risky, and how to fix them.",
};
