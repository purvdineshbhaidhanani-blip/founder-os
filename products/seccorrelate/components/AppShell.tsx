...
const NAV_LINKS: Array<{ id: string; label: string; href: string }> = [
  ...
  { id: "log-events", label: "Log events", href: "/log-events" },
  { id: "rules", label: "Correlation rules", href: "/rules" },
...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <DashboardShell navItems={navItems} logo={<span className="sc-landing-logo">SecCorrelate</span>}>
      {children}
    </DashboardShell>
  );
}
