...
export const metadata: Metadata = {
  title: "SchemaLint — AI database schema intelligence",
  description: "Catch missing indexes, missing keys, and naming drift in your database schema, with an AI Database Architect that recommends specific fixes before problems reach production.",
};
