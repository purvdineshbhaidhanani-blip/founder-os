...
export const metadata: Metadata = {
  title: "IncidentTriage — AI-powered incident intelligence",
  description: "Explains what broke, why it broke, and how to fix it — a 60-second AI-generated root cause brief.",
};
