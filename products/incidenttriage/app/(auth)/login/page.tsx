...
export default function LoginPage() {
  ...
  return (
    <main className="it-auth-page">
      <Card className="it-auth-card">
        <CardHeader>
          <CardTitle>Log in to IncidentTriage</CardTitle>
          <CardDescription>Welcome back.</CardDescription>
        </CardHeader>
        <CardContent>
          <form className="it-auth-form" onSubmit={handleSubmit}>
