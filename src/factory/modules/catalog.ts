...
export const BUILTIN_MODULES: PlatformModule[] = [
  ...
  },
  {
    ...
    category: "core",
    sourcePath: "src/factory/config/features.ts",
  },
  {
    id: "ai",
    name: "AI Engine",
  ...
  },
  {
    ...
    category: "workflow",
    sourcePath: "src/engines/workflow",
  },
  {
    id: "automation",
    ...
    category: "automation",
    dependsOn: ["workflow"],
    sourcePath: "src/engines/automation",
  },
  {
    id: "search",
    name: "Search Engine",
  ...
  },
  {
    ...
    category: "knowledge",
    dependsOn: ["ai"],
    sourcePath: "src/engines/knowledge",
  },
  {
    id: "notification",
    ...
    sourcePath: "src/engines/notification",
  },
  {
    id: "analytics",
    ...
    category: "analytics",
    sourcePath: "src/engines/analytics",
  },
  {
    ...
    sourcePath: "src/engines/logging-monitoring",
  },
  {
    id: "integration",
    ...
    sourcePath: "src/engines/integration",
  },
  {
    id: "storage",
    name: "Storage Engine",
    ...
    category: "storage",
    sourcePath: "src/engines/storage",
  },
  {
    id: "shared",
    name: "Shared Engine Utilities",
    description: "Cross-engine primitives (cron, scheduling, retry/backoff, template interpolation) reused by multiple engines.",
    category: "core",
    sourcePath: "src/engines/shared",
  },
];
