...
export const BUILTIN_INTELLIGENCE_MODULES: IntelligenceModuleDescriptor[] = [
  {
    ...
    sourcePath: "src/platform-intelligence/recommendation",
  },
  {
    id: "insights",
    ...
    version: "1.0.0",
    category: "insights",
    sourcePath: "src/platform-intelligence/insights",
  },
  {
    id: "decision",
    ...
    version: "1.0.0",
    category: "decision",
    sourcePath: "src/platform-intelligence/decision",
  },
  {
    ...
    sourcePath: "src/platform-intelligence/feature-intelligence",
  },
  {
    ...
    sourcePath: "src/platform-intelligence/product-intelligence",
  },
  {
    id: "ai-layer",
    ...
    version: "1.0.0",
    category: "ai-layer",
    sourcePath: "src/platform-intelligence/ai-layer",
  },
  {
    id: "diagnostics",
    ...
    sourcePath: "src/platform-intelligence/diagnostics",
  },
  {
    id: "optimization",
    ...
    sourcePath: "src/platform-intelligence/optimization",
  },
];
