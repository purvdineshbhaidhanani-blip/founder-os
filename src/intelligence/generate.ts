...
import { buildDepartmentBlueprint } from "../departments/blueprint.js";
import { MARKET_INTELLIGENCE_DEPARTMENT } from "./agents.js";
import { COMPANY_BRAIN_SPEC } from "../brain/spec.js";

const ROSTER = [...MARKET_INTELLIGENCE_DEPARTMENT, COMPANY_BRAIN_SPEC];
...
async function main(): Promise<void> {
  ...
  process.stdout.write(
    `\nGenerated ${ok}/${ROSTER.length} agents (${warned} with warnings, ${failed} failed).\n`,
  );
